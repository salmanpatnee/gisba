...
class CriscPost extends Model
{
    ...
    {
        return $this->belongsTo(CriscCategory::class, 'category_id');
    }

    public function attachments(): HasMany
    {
        return $this->hasMany(CriscPostAttachment::class);
    }
    ...
    {
        static::creating(function (CriscPost $post): void {
            if (empty($post->slug)) {
