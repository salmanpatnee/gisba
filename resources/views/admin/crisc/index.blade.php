<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">CRISC Posts</h2>
            <a href="{{ route('admin.crisc.create') }}"
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 text-right space-x-3">
                                <a href="{{ route('crisc.show', $post->slug) }}"
                                   target="_blank"
                                   class="text-blue-600 hover:text-blue-800 font-medium">View</a>
                                <a href="{{ route('admin.crisc.edit', $post) }}"
                                   class="text-indigo-600 hover:text-indigo-800 font-medium">Edit</a>
                                <form action="{{ route('admin.crisc.destroy', $post) }}" method="POST" class="inline"
                        ...
                        @empty
                        <tr>
                            <td colspan="4" class="px-6 py-10 text-center text-gray-500">No CRISC posts yet.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
