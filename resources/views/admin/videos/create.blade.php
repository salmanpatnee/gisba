                ...
                <form method="POST" action="{{ route('admin.videos.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-5">
                        ...
                        <input
                            ...
                            placeholder="e.g. Introduction to NIS2 Compliance"
                            required
                        >
                        @error('title')
                    ...
                    {{-- Video File --}}
                    <div class="mb-6">
                        <label for="video" class="block text-sm font-medium text-gray-700 mb-1">Video File <span class="text-red-500">*</span></label>
                        <input
                            type="file"
                            id="video"
                            name="video"
                            ...
                            required
                        >
                        <p class="mt-1 text-xs text-gray-500">Accepted formats: MP4, WebM, OGG &mdash; maximum 500 MB.</p>
                        @error('video')
                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
