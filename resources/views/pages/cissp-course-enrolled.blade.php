...
@section('title', 'Enrollment Confirmed — CISSP Live Online Training')
@section('meta_description', 'Your enrollment in the GISBA CISSP Live Online Training is confirmed.')
    ...
    <div class="container">
      <div class="enrollment-card">
        ...
        <p class="enrollment-message">
          @if($enrollmentName)
            Thanks, {{ $enrollmentName }} — your seat in the CISSP Live Online Training is confirmed.
          @else
            Your seat in the CISSP Live Online Training is confirmed.
          @endif
        ...
        <a href="{{ route('cissp') }}" class="btn-enrollment-cta">
          <i class="bi bi-shield-lock"></i>Back to Course Details
        </a>
