...
@section('title', ($post->meta_title ?? $post->title) . ' | GISBA CRISC')
      ...
      <div class="col-12 col-lg-4">
        <div style="position:sticky;top:16px;">
          ...
          <div class="article-sidebar-card">
            ...
            <p style="font-size:12.5px;color:var(--text-muted);margin-top:12px;margin-bottom:0;line-height:1.6;">Practising consultants with hands-on experience delivering IT risk management and cybersecurity governance programmes across global organisations since 2006.</p>
          </div>
          ...
          <div class="article-sidebar-card">
            ...
            <a href="{{ route('crisc.show',$relatedPost->slug) }}" class="related-post-item">
          ...
          <div class="article-sidebar-card">
            ...
            <ul style="list-style:none;padding:0;margin:0;">
              <li style="padding:7px 0;border-bottom:1px solid var(--border-light);">
                <a href="{{ route('crisc-course') }}" style="font-size:13px;font-weight:600;color:var(--navy);text-decoration:none;display:flex;align-items:center;gap:8px;transition:color 0.2s;" onmouseover="this.style.color='var(--navy-light)'" onmouseout="this.style.color='var(--navy)'">
                  <i class="bi bi-mortarboard" style="color:var(--accent);"></i> CRISC Online Course
                </a>
              </li>
