...
@section('title', 'Success Stories — Middle East | GISBA Consultants')
@section('meta_description', 'Explore GISBA success stories — real-world cybersecurity consulting and training engagements delivered across the Middle East.')

@section('banner')
  <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
    <span><i class="bi bi-star me-2"></i>GISBA Success Stories — Middle East</span>
...
@section('footer_tagline')
  ...
  Middle East — Cybersecurity Consulting &amp; Training.
@endsection
        ...
        <section class="hero-section container">
          <div class="row align-items-center">
            ...
            <div class="col-md-6 text-center">
              <img class="image-content img-fluid" src="{{ asset('assets/images/thumbsup.png') }}" alt="GISBA Success Stories Middle East">
            </div>
          </div>
        </section>
      </main>
    ...
    <div class="container">
      ...
      <div class="row g-4 gy-4">
        <div class="col-12 ss-reveal">
          <div class="ss-featured-card" data-img="{{ asset('assets/images/success_stories/me/Slide3.jpg') }}" data-caption="Operational and Trusted Since 2006 – 20 Years of Consulting Excellence">
            <img src="{{ asset('assets/images/success_stories/me/Slide3.jpg') }}" alt="Operational and Trusted Since 2006" loading="lazy">
  ...
  <section id="ss-recognition" class="ss-section">
    <div class="container">
      ...
      <div class="ss-grid">
        ...
        <div class="ss-card ss-reveal" data-img="{{ asset('assets/images/success_stories/me/' . $file) }}" data-caption="{{ $caption }}">
          <div class="ss-card-img-wrap">
            <img src="{{ asset('assets/images/success_stories/me/' . $file) }}" alt="{{ $caption }}" loading="lazy">
  ...
  <section id="ss-iso27001" class="ss-section">
    <div class="container">
      <div class="ss-section-header ss-reveal">
        ...
        <div class="ss-accent-bar"></div>
        <p class="ss-section-desc">Decades of leadership in cybersecurity — from early implementations to cutting-edge cloud security and PCI/DSS compliance.</p>
      </div>
      <div class="ss-grid">
        @foreach([
