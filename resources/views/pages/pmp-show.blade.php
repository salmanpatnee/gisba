...
@section('title', ($post->meta_title ?? $post->title) . ' | GISBA PMP')
@section('meta_description', $post->meta_description ?? $post->excerpt)

@section('banner')
  <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
    <span><i class="bi bi-award me-2"></i>PMP Resources &mdash; {{ $post->category?->name ?? 'Uncategorized' }}</span>
    <div class="d-flex gap-3">
      <a href="{{ route('pmp') }}"><i class="bi bi-arrow-left me-1"></i>All Articles</a>
  ...
  <div class="container">
    <div class="row g-4">
      ...
      <div class="col-12 col-lg-8">
        ...
        <a href="{{ route('pmp') }}" class="back-link"><i class="bi bi-arrow-left"></i> Back to All Articles</a>
        ...
        <div class="article-content-wrap">
          ...
          <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
            ...
            <a href="{{ route('pmp') }}" class="back-link" style="margin-bottom:0;">
        ...
        <div class="article-bottom-cta">
          ...
          <div class="d-flex gap-3 flex-wrap">
            <a href="{{ route('pmp.pricing') }}" class="btn-hero-primary">{{ $pmpPrice }} — Get PMP Training</a>
      ...
      <div class="col-12 col-lg-4">
        <div style="position:sticky;top:16px;">
          ...
          <div class="article-sidebar-card">
            ...
            <div class="author-info">
              ...
              <div>
                ...
                <span class="author-role">GISBA Project Management Consultants</span>
              </div>
            </div>
            <p style="font-size:12.5px;color:var(--text-muted);margin-top:12px;margin-bottom:0;line-height:1.6;">Practising consultants with hands-on experience delivering PMP programmes, agile transformations, and project governance frameworks across global organisations since 2006.</p>
          </div>
          ...
          <div class="article-sidebar-card">
            ...
            <a href="{{ route('pmp.show', $relatedPost->slug) }}" class="related-post-item">
