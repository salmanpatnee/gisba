...
@section('title', 'Success Stories — Europe | GISBA Consultants')
@section('meta_description', 'Explore GISBA success stories — real-world cybersecurity consulting and training engagements delivered across Europe.')

@section('banner')
  <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
    <span><i class="bi bi-star me-2"></i>GISBA Success Stories — Europe</span>
...
@section('footer_tagline')
  ...
  Europe — Cybersecurity Consulting &amp; Training.
@endsection
      ...
      <main class="img-content">
        <section class="hero-section container">
          <div class="row align-items-center">
            <div class="col-md-6">
              <h1 class="hero-title">Success Stories<br /><span>Europe</span></h1>
              <p class="hero-subtitle">Measurable Cybersecurity Outcomes Across European Industries</p>
              <p class="hero-desc">A documented record of real-world engagements — measurable outcomes delivered for European clients across industries since <strong>2006</strong>.</p>
            </div>
            <div class="col-md-6 text-center">
              <img class="image-content img-fluid" src="{{ asset('assets/images/thumbsup.png') }}" alt="GISBA Success Stories Europe">
            </div>
          </div>
        </section>
      </main>
  ...
  <section id="ss-intro" class="ss-section">
    <div class="container">
      ...
      <div class="row g-4 gy-4">
        <div class="col-12 ss-reveal">
          <div class="ss-featured-card" data-img="{{ asset('assets/images/success_stories/eu/Slide4.png') }}" data-caption="Our Achievements — A 20-Year Track Record">
            <img src="{{ asset('assets/images/success_stories/eu/Slide4.png') }}" alt="Our Achievements" loading="lazy">
  ...
  <section id="ss-recognition" class="ss-section">
    <div class="container">
      ...
      <div class="ss-grid">
        ...
        <div class="ss-card ss-reveal" data-img="{{ asset('assets/images/success_stories/eu/' . $file) }}" data-caption="{{ $caption }}">
          <div class="ss-card-img-wrap">
            <img src="{{ asset('assets/images/success_stories/eu/' . $file) }}" alt="{{ $caption }}" loading="lazy">
  ...
  <section id="ss-iso22301" class="ss-section">
    <div class="container">
      <div class="ss-section-header ss-reveal">
        ...
        <div class="ss-accent-bar"></div>
        <p class="ss-section-desc">Delivering resilience for enterprises across Europe and beyond — including government, banking, and critical infrastructure sectors.</p>
      </div>
      <div class="ss-grid">
        @foreach([
