...
@section('meta_description', 'Watch domain summary videos for '.$chapter->title.'.')

@section('banner')
  <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
    <span><i class="bi bi-play-circle me-2"></i>Domain Summary in Poetry</span>
...
<div class="rp-header">
  <div class="container">
    <div class="rp-meta">
      <span class="rp-type-label"><i class="bi bi-play-circle-fill"></i> Domain Summary in Poetry</span>
  ...
  <div class="container">
    ...
    @if($chapter->resources->isEmpty())
      <div style="text-align:center;padding:72px 0;color:#9ca3af;">
        ...
        <p style="font-size:14.5px;margin:0;">No domain summary videos uploaded yet. Check back soon.</p>
      </div>
    @else
      <div class="row g-4">
