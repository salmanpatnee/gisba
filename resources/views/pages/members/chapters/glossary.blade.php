...
@section('title', $chapter->title.' — Glossary | GISBA Members')
@section('meta_description', 'Key terms and definitions for '.$chapter->title.'.')

@section('banner')
  <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
    <span><i class="bi bi-book me-2"></i>Glossary</span>
...
<div class="rp-header">
  <div class="container">
    <div class="rp-meta">
      <span class="rp-type-label"><i class="bi bi-book-fill"></i> Glossary</span>
