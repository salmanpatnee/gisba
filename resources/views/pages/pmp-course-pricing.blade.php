...
@section('title', 'PMP Live Online Training — Enrollment | GISBA Consultants')
@section('meta_description', 'Enroll in the GISBA PMP Live Online Training — $' . number_format((float) $pricing->pmp_price, 2) . '. Limited to ' . $pricing->pmp_capacity . ' participants.')

@section('banner')
  <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
    <span><i class="bi bi-award me-2"></i>PMP Live Online Training — Enrollment</span>
    <div class="d-flex gap-3">
      <a href="{{ route('pmp') }}"><i class="bi bi-arrow-left me-1"></i>Back to Course</a>
...
@section('footer_tagline')
  PMP Live Online Training<br />
  Project Management Professional Insights.
@endsection
  ...
  <div class="nis2-pricing-page">
    <div class="container">
      ...
      <div class="pricing-page-header">
        <h1 class="pricing-page-title">PMP Live Online Training</h1>
        <p class="pricing-page-subtitle">A live, instructor-led course limited to {{ $pricing->pmp_capacity }} participants, aligned with PMBOK&reg; 8th Edition and the PMP Exam Content Outline.</p>
      </div>
      ...
      <div class="pricing-table-wrap">
        ...
        <div class="pt-card" style="position:relative; overflow:visible;" x-data="{
               fullPrice: {{ (float) $pricing->pmp_price }},
          ...
          <div class="pt-ribbon">
            <i class="bi bi-people-fill me-1"></i>Limited to {{ $pricing->pmp_capacity }} Participants
          </div>

          <div class="pt-card-header" style="padding-top:28px;">
            <div class="pt-plan-name">PMP Live Online Training</div>
            ...
            <div class="pt-price" :style="applied ? 'font-size:2.75rem;' : ''">
              ...
              <template x-if="applied">
                <span style="display:inline-flex; align-items:baseline; gap:10px;">
                  <span style="text-decoration:line-through; opacity:0.5; font-size:0.55em;">${{ number_format((float) $pricing->pmp_price, 2) }}</span>
            ...
            <div class="pt-billing">
              ...
              @if($pricing->pmp_date)
                ...
                @if($pricing->pmp_time_start)
                  , {{ $pricing->pmp_time_start }}&ndash;{{ $pricing->pmp_time_end }} ({{ $pricing->pmp_timezone }})
                @endif
              @else
          ...
          <div class="pt-card-body">
            ...
            <ul class="pt-features">
              <li><i class="bi bi-check-circle-fill"></i>Live, instructor-led PMP training aligned with PMBOK&reg; 8th Edition</li>
              <li><i class="bi bi-check-circle-fill"></i>Complete coverage of all PMP Exam Content Outline domains</li>
              <li><i class="bi bi-check-circle-fill"></i>Plenty of practice quizzes and knowledge checks</li>
              <li><i class="bi bi-check-circle-fill"></i>Small-group format — max {{ $pricing->pmp_capacity }} participants</li>
              <li><i class="bi bi-check-circle-fill"></i>Conducted by the author of "Encyclopedia of Project Management: Beyond PMP"</li>
            </ul>

            <form action="{{ route('pmp.checkout') }}" method="POST">
              @csrf
              ...
              <div class="mb-3 form-check">
                ...
                <label for="consent" class="form-check-label" style="font-size:12.5px;">
                  I consent to the use of my information by GISBA for training preparation, follow-ups, and related activities.
                </label>
              </div>
