      ...
      <div class="pricing-table-wrap">
        ...
        <div class="pt-card" style="position:relative; overflow:visible;">
          ...
          <div class="pt-card-body">
            ...
            @if ($pricing->prince2_seats_remaining > 0)
              <p class="pt-payment-label">{{ $pricing->prince2_seats_remaining }} of {{ $pricing->prince2_capacity }} seats remaining</p>
            ...
            @else
              <div class="pt-bank-details" style="display:block;">
                ...
                <p class="pt-bank-note" style="border-top:none;">
                  ...
                  All {{ $pricing->prince2_capacity }} seats have been reserved. <a href="{{ route('contact-us') }}">Contact us</a> to join the waitlist for the next session.
                </p>
              </div>
            @endif
