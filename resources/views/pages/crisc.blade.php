...
@section('title', 'CRISC Articles | GISBA Consultants — Cybersecurity Insights & Compliance Guidance')
@section('meta_description', 'Expert insights on CRISC, IT risk management, and cybersecurity governance from the GISBA consulting team.')

@section('banner')
  <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
    <span><i class="bi bi-journal-text me-2"></i>GISBA CRISC Articles — Risk & Compliance Insights</span>
    <div class="d-flex gap-3">
      <a href="{{ route('crisc-course') }}"><i class="bi bi-mortarboard me-1"></i>CRISC Course</a>
  ...
  <div class="container">
    <div class="hero-section blog-hero">
      <div class="row align-items-center g-4">
        <div class="col-12">
          <span class="blog-hero-label"><i class="bi bi-mortarboard-fill me-1"></i> CRISC Insights</span>
          <h1 class="blog-hero-title">IT Risk &amp; Compliance<br /><span>Insights from the Field</span></h1>
          <p class="blog-hero-desc">Practical perspectives on IT risk management, cybersecurity governance, and CRISC exam preparation — from consultants who deliver these outcomes for clients every day.</p>
        </div>
      </div>
    </div>
  </div>
...
{{-- ── CRISC Course Promo Banner ──────────────────────────────────────── --}}
<section style="padding:32px 0;">
  <div class="container">
    <div class="d-flex align-items-center justify-content-between flex-wrap gap-3" style="background:linear-gradient(135deg, #001f4d 0%, #003b82 100%); border-radius:var(--radius-lg); padding:24px 32px;">
      <div>
        <span style="font-size:11px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:var(--accent);">Limited to 12 Participants</span>
        <h3 style="font-family:var(--font-display);color:#fff;font-size:1.15rem;font-weight:800;margin:6px 0 0;">Enroll in the CRISC Online Course</h3>
      </div>
      <a href="{{ route('crisc-course') }}" class="btn-hero-primary">Learn More</a>
    </div>
  </div>
</section>
