...
@section('title', 'Enrollment Confirmed — PMP Live Online Training')
@section('meta_description', 'Your enrollment in the GISBA PMP Live Online Training is confirmed.')
    ...
    <div class="container">
      <div class="enrollment-card">
        ...
        <p class="enrollment-message">
          @if($enrollmentName)
            Thanks, {{ $enrollmentName }} — your seat in the PMP Live Online Training is confirmed.
          @else
            Your seat in the PMP Live Online Training is confirmed.
          @endif
        ...
        <a href="{{ route('pmp') }}" class="btn-enrollment-cta">
          <i class="bi bi-award"></i>Back to Course Details
        </a>
